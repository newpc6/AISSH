...
export const REQUIRED_CORE_CAPABILITIES = ['ai-assist', 'ai-agent', 'ai-stream', 'ai-unified', 'ai-chat-history', 'ai-agent-audit']
...
export function normalizeAppSettings(value: Partial<AppSettings> = {}): AppSettings {
  ...
  return {
    ...
    aiAgentEnabled: value.aiAgentEnabled ?? defaultSettings.aiAgentEnabled,
